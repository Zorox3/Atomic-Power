...
import de.atomicpower.tileEntities.TileEntityRegistry;
...
public class AtomicPower {
	...
	public static TileEntityRegistry tileEntityRegstry;
	...
	public static void init(FMLInitializationEvent event) {
		tileEntityRegstry = new TileEntityRegistry();
		tileEntityRegstry.register();
		
		serverproxy.registerProxies();
	}
